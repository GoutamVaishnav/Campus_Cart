...
export default function ProfileScreen() {
  ...
  useEffect(() => {
    if (!loading && user) {
      Animated.stagger(100, [
        ...
        Animated.spring(cardAnim, { toValue: 1, tension: 20, friction: 7, useNativeDriver: true }),
        Animated.spring(listAnim, { toValue: 1, tension: 20, friction: 7, useNativeDriver: true }),
      ]).start();
    }
  }, [loading, user]);
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* Header gradient */}
        <LinearGradient colors={["#c3b5b0", "#0088ff"]} style={styles.headerGradient}>
          <Animated.View style={animStyle(headerAnim)}>
            ...
            <View style={styles.avatarWrap}>
              <View style={styles.avatarRing}>
                <View style={styles.avatar}>
                  <Text style={styles.avatarLetters}>{getInitials(user?.name)}</Text>
                </View>
              </View>
              {user?.verified && (
            ...
            <View style={styles.verifiedPill}>
              ...
              />
              <Text style={[styles.verifiedText, { color: user?.verified ? "#00C48C" : "#FFA500" }]}>
        ...
        <View style={styles.body}>
          ...
          <Animated.View style={animStyle(listAnim)}>
            ...
            <MenuItem icon="bag-handle-outline"    label="My Listings"        onPress={() => {}} />
            <MenuItem icon="heart-outline"         label="Wishlist"           onPress={() => {}} />
            <MenuItem icon="time-outline"          label="Purchase History"   onPress={() => {}} />
            <MenuItem icon="notifications-outline" label="Notifications"      onPress={() => {}} />
            <MenuItem icon="shield-outline"        label="Privacy & Security" onPress={() => {}} />
            <MenuItem icon="help-circle-outline"   label="Help & Support"     onPress={() => {}} />

            <TouchableOpacity style={styles.logoutBtn} onPress={handleLogout} activeOpacity={0.85}>
              <LinearGradient colors={["#ff6b6b", "#ee4444"]} style={styles.logoutGradient}>
...
const styles = StyleSheet.create({
  ...
  avatarLetters: { fontSize: 32, fontWeight: "900", color: "#0088ff" },
  verifiedBadge: {
  ...
  userCollege: { fontSize: 13, color: "rgba(255,255,255,0.8)", fontWeight: "500", marginBottom: 12 },
  verifiedPill: {
  ...
  statNumber: { fontSize: 22, fontWeight: "900", color: "#1A1A2E", marginBottom: 3 },
  statLabel: {
    fontSize: 11, color: "#8E8E9A", fontWeight: "600",
...
const infoStyles = StyleSheet.create({
  ...
  textWrap: { flex: 1 },
  label: {
    fontSize: 10, fontWeight: "700", color: "#8E8E9A",
